...
<template>
    <div class="h-screen grid grid-cols-[20rem_minmax(20rem,_1fr)] grid-rows-[6rem_1fr] bg-user-page-light-bg gap-1">
      <header class="col-start-2 bg-page-light-bg">
      ...
      <aside class="col-start-1 row-span-full flex flex-col justify-between bg-page-light-bg">
        ...
        <nav>
          <ul class="flex flex-col">
            <li>
              <RouterLink :to="{name: 'user-main'}" class="flex gap-3 items-center p-8 ml-5 rounded-l-full bg-page-light-bg">
            ...
            <li>
              <RouterLink :to="{name: 'user-orders'}" class="flex gap-3 items-center p-8 ml-5 rounded-l-full bg-page-light-bg">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <RouterLink :to="{name: 'user-analitics'}" class="flex gap-3 items-center p-8 ml-5 rounded-l-full bg-page-light-bg">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <RouterLink :to="{name: 'user-rent'}" class="flex gap-3 items-center p-8 ml-5 rounded-l-full bg-page-light-bg">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <RouterLink :to="{name: 'user-settings'}" class="flex gap-3 items-center p-8 ml-5 rounded-l-full bg-page-light-bg">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
